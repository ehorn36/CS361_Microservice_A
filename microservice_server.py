...
while True:
    ...
    main_title = json["labels"]["title"]
    x_axis_label = json["labels"]["x-axis"]
    y_axis_label = json["labels"]["y-axis"]

    # Extract data from JSON file.
    x_axis_data = json["x-axis-data"]
    y_axis_data = json["y-axis-data"]
    ...
    graph_image_bytes = bytearray(graph_image.read())
